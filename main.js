...
object_to_be_drawn = Math.floor((Math.random()*array_1.length)+1);
element = array_1[object_to_be_drawn];
console.log(element);
document.getElementById("object_to_be_drawn").innerHTML = "Draw a " + element;
i = 120;
